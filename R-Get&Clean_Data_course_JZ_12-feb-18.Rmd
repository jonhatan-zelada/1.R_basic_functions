...
ara.dqa.dep$area<-str_replace_all(ara.dqa.dep$area,"ó","o")
# remove accents
ara.dqa.dep$area<-chartr("áéíóú", "aeiou",ara.dqa.dep$area)   
...
.  "date"
```{r "date"}
###a.ARANDA: Creating new field "fecha" for Analysis  with the form "AÑO-MES"
